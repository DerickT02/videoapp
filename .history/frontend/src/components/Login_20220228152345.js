...
function Login(){
    ...
    const login = async  (e) => {
      ...
      setTimeout(1000, window.location.refresh())
    ...
    return(
        ...
        <div className="form">
          ...
          <form className="login-form">
            ...
            {!registerUser ? <Link to = '/homepage'><button onClick = {(e) => {login(e)}}>Login</button></Link> : <button onClick = {(e) => {register(e)}}>Register</button>}
